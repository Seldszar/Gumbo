...
import NumberInput from "~/browser/components/NumberInput";
...
export function Component() {
  ...
  return (
    <Section>
      <FormField title={t("inputLabel_refreshInterval")}>
        <NumberInput
          {...register("general.refreshInterval")}
          rightOrnament={t("inputLabel_refreshInterval_minutes")}
          min={1}
        />
      </FormField>
